...
class JsonClass: NSObject {
    ...
    let urlBase = "http://localhost:8080/php/"//url del servidor remoto
     ...
     */
    func arrayFromJson(url:String,datos_enviados:NSMutableDictionary, completionHandler: @escaping (NSArray?) -> Void){
